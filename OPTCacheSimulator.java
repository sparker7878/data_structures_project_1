...
public class OPTCacheSimulator {
	...
	/**
	* Method which simulates the cache processing
	* @param address represents an integer
	* @param stackDist corresponding stack distance for the address
	* @return a boolean value representing whether the access is cache hit or miss
	*
	*/
